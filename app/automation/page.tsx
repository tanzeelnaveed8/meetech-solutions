               ...
               <section className=" relative py-20 px-page-x bg-accent-muted/60 text-text-inverse overflow-hidden relative">
                    ...
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                         <div className="space-y-6">
                              <h2 className="text-text-primary font-bold leading-tight text-4xl   md:text-6xl uppercase">Tailored Solutions for  <span className="text-accent block ">Every Industry</span></h2>
